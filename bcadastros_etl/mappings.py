"""Mapeamentos locais mantidos fora das regras de transformacao."""
...
# Regra F de tmp/regras.md. As grafias foram preservadas para manter aderencia funcional.
MOTIVO_SITUACAO = {
    "00": "SEM MOTIVO",
    ...
    "54": (
        "EXTINCAO - TRATAMENTO DIFERENCIADO DADO AS ME E EPP "
        "(LEI COMPLEMENTAR NUMERO 123/2006)"
    ),
...
SITUACOES_TERMINAIS = frozenset({"01", "04", "08"})
